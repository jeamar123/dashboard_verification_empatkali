		...
		<div class="verification-details-content p-4">
			<div class="grid details-grid gap-3 h-full w-full">
				<div class="card p-4 relative">
					<div class="corner-status absolute right-0 top-0 bg-v-status-pending px-6 py-1 text-white font-bold xs-text rounded-tr-xl rounded-bl-xl">
						Pending
					</div>
...
<script>
	import Pending from './function.vue'
