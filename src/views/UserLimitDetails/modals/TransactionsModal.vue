        ...
        <tr v-if="list.showDrop">
          ...
          >
            ...
            <div v-if="terms.number!==1">
              ...
              <button v-if="mapTransactionTerms(terms).btnCheckPayment" @click.prevent="checkPayment(list, terms)" class="btn rounded-md px-8 py-2 bg-white border border-violet w-44 text-xs text-violet font-bold mt-2 mb-3">Check Payment</button>

              <div v-if="mapTransactionTerms(terms).btnGenerateVA">
