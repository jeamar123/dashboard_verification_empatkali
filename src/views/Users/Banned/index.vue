<template>
	<div>
		<div v-if="isBanStatusAlertShow" class="bg-white p-4 rounded-xl shadow-md fixed right-10 top-14 z-50 w-68">
			<div class="flex">
				...
				<div class="flex-1">
					...
					<p class="text-sm">Kamu berhasil unbanned user. </p>
				</div>
		...
		>
			<UnBanUserModal :user="selectedUser" :closeModal="toggleModals" :requestSuccess="refreshData" :toggleLoader="toggleLoader"/>
		</Modal>
	</div>
</template>
...
<script>
	import Banned from './function.vue'
