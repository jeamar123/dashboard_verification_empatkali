<template>
	<div>
				...
				<table class="w-full text-left">
					<thead>
						<tr>
							...
							<th class="border-b-2 py-3 text-sm text-center w-48">Aksi</th>
						</tr>
					</thead>
					<tbody>
		...
		>
			<BanUserModal :user="selectedUser" :closeModal="toggleModals" :requestSuccess="refreshData" :toggleLoader="toggleLoader"/>
		</Modal>
	</div>
</template>
...
<script>
	import Active from './function.vue'
