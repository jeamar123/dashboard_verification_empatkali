<template>
  <div>
    <p class="text-sm mt-2 mb-4">Kamu yakin akan unbanned user ini :</p>
    <div class="flex mb-3">
    ...
    <div class="flex mb-3">
      ...
      <p class="flex-1 text-sm font-bold">{{ 'elon@empatkali.co.id' }}</p>
    </div>
    ...
    <div class="text-right mt-8">
      ...
      <button class="btn px-6 py-3 mx-1 bg-violet font-bold text-white rounded-md text-sm">UnBanned</button>
    </div>
  </div>
</template>
